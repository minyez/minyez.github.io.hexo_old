...
**PS**: Valhalla在老伊达([The Poetic Edda](https://en.wikipedia.org/wiki/Poetic_Edda))里有记录, 想起来之前读文史大纲的时候遇到过, 见[郑振铎全集](https://book.douban.com/subject/1203864/)第十卷P343. 
...
**N.B.** 如果需要检查*内存泄漏以外*的问题, 尽量使用`-O0`. 这个可以在后面的例子里看到.
